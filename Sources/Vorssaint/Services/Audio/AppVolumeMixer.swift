...
final class AppVolumeMixer: ObservableObject {
    ...
    private let buildQueue = DispatchQueue(label: "com.woosh.utils.mixer", qos: .userInitiated)
    ...
    private let halQueue = DispatchQueue(label: "com.woosh.utils.mixer.hal", qos: .userInitiated)
...
private final class TapGainEngine: GainEngine {
    ...
    private static let rateQueue = DispatchQueue(label: "com.woosh.utils.mixer.rate",
                                                 qos: .userInitiated)
    ...
    private static let teardownQueue = DispatchQueue(label: "com.woosh.utils.mixer.teardown",
                                                     qos: .utility)
