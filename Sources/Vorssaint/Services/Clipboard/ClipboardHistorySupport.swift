...
struct ClipboardHistoryEntry: Codable, Equatable, Identifiable {
    ...
    let imageWidth: Int?
    let imageHeight: Int?
    /// Bundle ID of the application that copied this entry (e.g. "com.apple.Safari").
    let appBundleID: String?
    /// Localized name of the application that copied this entry.
    let appName: String?
    ...
    var kindDisplayLabel: String {
        ...
        case .image:
            return "Image"
        case .files:
            return filePaths.count == 1 ? "File" : "\(filePaths.count) files"
        }
    }
    ...
    var preview: String {
        ...
        case .image:
            return imageDimensionsLabel.isEmpty ? "Image" : imageDimensionsLabel
        case .files:
    ...
    private enum CodingKeys: String, CodingKey {
        case id, text, copiedAt, pinnedAt, kind, filePaths, imageFile, imageHash, imageWidth, imageHeight, appBundleID, appName
    }
